...
$commandes = $bdd->query("SELECT * FROM bons_commande ORDER BY id DESC");
?>
<div class="content">
     <!-- content nav -->
     ...
     <!-- conetent  end -->
        <div class="row mb-4">
            ...
            <!-- Modal -->
             <?php include_once "add_commande.php"; ?>
             <?php include_once "fiche_commande.php" ?>
             <?php include_once "historique_commande.php" ?>
            ...
            <div class="col-12 col-lg-12 col-xl-12">
                ...
                <div class="card-body">
                    ...
                    <div class="row justify-content-between align-items-center g-0 mb-3">
                        ...
                        <div class="col-auto">
                            <button class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addSupplierModal" type="button"><span class="fa fa-plus me-1"></span>Ajouter une commande</button>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered table-striped fs--1 mb-0">
                            <thead class="bg-200 text-900">
                                <tr>
                                    ...
                                    <th class="sort" data-sort="date_commande">Date de commande</th>
                                    <th class="sort" data-sort="nom_client">Nom du client</th>
                                    <th class="sort" data-sort="telephone">Téléphone</th>
                                    <th class="sort" data-sort="adresse_livraison">Adresse de livraison</th>
                                    <th class="sort" data-sort="quantite">Quantité</th>
                                    <th class="sort" data-sort="prix_unitaire">Prix Unitaire</th>
                                    <th>Actions</th>
                                </tr>
                            </thead>
                            <tbody class="list">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $commande['prix_unitaire']; ?></td>
                                    <td>
                                        <a href='' class="btn btn-sm btn-warning get_id" data-id = "<?php echo $commande['id']; ?>" data-bs-toggle = "modal" data-bs-target = "#myModal" id = "<?php echo $commande['id']; ?>"><span class="fa fa-edit"></span></a>
