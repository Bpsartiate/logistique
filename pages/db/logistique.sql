...
--
-- Hôte : 127.0.0.1
-- Généré le : mar. 15 juil. 2025 à 11:09
...
--
-- Structure de la table `plan_approvisionnement`
--
...
--
-- Déchargement des données de la table `plan_approvisionnement`
--
...
--
-- Structure de la table `type_procedure`
--
...
--
-- Déchargement des données de la table `type_procedure`
--
...
--
-- Déchargement des données de la table `t_about`
--
...
--
-- Structure de la table `t_activites_prog`
--

CREATE TABLE `t_activites_prog` (
  `Id` int(11) NOT NULL,
  `Rubriques` mediumtext NOT NULL,
  `SRubriques` mediumtext NOT NULL,
  `Descriptions` mediumtext NOT NULL,
  `IdP` int(11) NOT NULL,
  `TitreP` mediumtext NOT NULL,
  `DateDebutP` date NOT NULL,
  `DateFinP` date NOT NULL,
  `BLine` mediumtext NOT NULL,
  `ActivitesP` mediumtext NOT NULL,
  `Quantites` float NOT NULL,
  `Pu` float NOT NULL,
  `Un` mediumtext NOT NULL,
  `CoutTotal` float NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `t_activites_prog`
--
...
--
-- Structure de la table `t_agents`
--
...
CREATE TABLE `t_agents` (
  ...
  `niveauAcces` varchar(255) NOT NULL,
  `Provenance` varchar(20) NOT NULL,
  `Etat_civil` varchar(11) NOT NULL,
  `Nombre_Enfants` text NOT NULL,
  `Genre` varchar(1) NOT NULL,
  `Integrer` varchar(3) NOT NULL DEFAULT 'NON',
  `numero_Telephone` varchar(25) NOT NULL,
  `mentor` varchar(30) NOT NULL DEFAULT 'AUCUN',
  `mentor_temp` varchar(30) DEFAULT NULL,
  `email` varchar(40) NOT NULL,
  `souhait` varchar(3) NOT NULL DEFAULT 'NON',
  `placer` varchar(1) NOT NULL,
  `dateNaissance` text NOT NULL,
  `lieuNaissance` varchar(255) NOT NULL,
  `Nationalite` varchar(255) NOT NULL,
  `nomEpoux` varchar(255) NOT NULL,
  `dateDeMariage` varchar(255) NOT NULL,
  `nomDuPere` varchar(255) NOT NULL,
  `nomDeLaMere` varchar(255) NOT NULL,
  `Adresse` varchar(255) NOT NULL,
  `carteIdentite` text NOT NULL,
  `lieudeDelivrance` varchar(255) NOT NULL,
  `dateDeDelivrance` text NOT NULL,
  `lieuDuTravail` varchar(255) NOT NULL,
  `dateDebutTravail` text NOT NULL,
  `dateFinTravail` text NOT NULL,
  `Grade` varchar(255) NOT NULL,
  `noINSS` varchar(255) NOT NULL,
  `Poste` varchar(255) NOT NULL,
  `id_mentor` varchar(255) NOT NULL,
  `id_entreprise` varchar(200) NOT NULL DEFAULT '66b9d43cd032f'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `t_agents`
--
...
--
-- Structure de la table `t_agentsintegres`
--
...
CREATE TABLE `t_agentsintegres` (
  ...
  `nomDeLaMere` varchar(255) NOT NULL,
  `Adresse` varchar(255) NOT NULL,
  `carteIdentite` varchar(255) NOT NULL,
  `lieudeDelivrance` varchar(255) NOT NULL,
  `dateDeDelivrance` varchar(255) NOT NULL,
  `lieuDuTravail` varchar(255) NOT NULL,
  `dateDebutTravail` varchar(255) NOT NULL,
  `dateFinTravail` varchar(255) NOT NULL,
  `Grade` varchar(255) NOT NULL,
  `noINSS` varchar(255) NOT NULL,
  `Poste` varchar(255) NOT NULL,
  `qrcode` varchar(50) NOT NULL,
  `dateIntegration` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `t_agentsintegres`
--
...
--
-- Structure de la table `t_alldeloc`
--
...
--
-- Déchargement des données de la table `t_alldeloc`
--
...
--
-- Structure de la table `t_allfam`
--
...
--
-- Déchargement des données de la table `t_allfam`
--
...
--
-- Structure de la table `t_allloge`
--
...
--
-- Déchargement des données de la table `t_allloge`
--
...
--
-- Structure de la table `t_alltrans`
--
...
--
-- Déchargement des données de la table `t_alltrans`
--
...
CREATE TABLE `t_annonces` (
  `id` int(11) NOT NULL,
  `titreAnnonce` varchar(30) NOT NULL,
  `objectifsAnnonce` varchar(255) NOT NULL,
  `datePublication` text NOT NULL,
  `nomMentor` varchar(40) NOT NULL,
  `emailMentor` varchar(40) NOT NULL,
...
--
-- Déchargement des données de la table `t_answers`
--
...
--
-- Structure de la table `t_answerskill`
--
...
--
-- Déchargement des données de la table `t_answerskill`
--
...
--
-- Structure de la table `t_archiveclasseur`
--

CREATE TABLE `t_archiveclasseur` (
  `id` int(11) NOT NULL,
  `uniqueId` char(38) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `design` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Déchargement des données de la table `t_archiveclasseur`
--
...
--
-- Structure de la table `t_archivedossier`
--
...
--
-- Déchargement des données de la table `t_archivedossier`
--
...
--
-- Structure de la table `t_archivefichier`
--
...
CREATE TABLE `t_archivefichier` (
  ...
  `Size` varchar(200) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Legende` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `dateDoc` datetime NOT NULL,
...
CREATE TABLE `t_articles` (
  `id_article` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `intitule_article` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `photo_article` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `description` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `date_ajout` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
--
-- Structure de la table `t_avances`
--

CREATE TABLE `t_avances` (
  `Id` int(11) NOT NULL,
  `Noms` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `Fonction` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `Montant` float NOT NULL,
  `Mois` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `Annee` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `t_avances`
--
...
--
-- Structure de la table `t_avancess`
--
...
--
-- Déchargement des données de la table `t_avancess`
--
...
--
-- Structure de la table `t_blog`
--

CREATE TABLE `t_blog` (
  `id` int(11) NOT NULL,
  `idDestinataire` int(11) NOT NULL,
  `messages` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `heureEnvoie` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `t_blog`
--
...
--
-- Structure de la table `t_calcul`
--

CREATE TABLE `t_calcul` (
  `Id` int(11) NOT NULL,
  `Organisation` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `CodeSecret` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
--
-- Déchargement des données de la table `t_calcul`
--
...
--
-- Structure de la table `t_cal_parametre`
--
...
--
-- Déchargement des données de la table `t_cal_parametre`
--
...
--
-- Structure de la table `t_canal`
--

CREATE TABLE `t_canal` (
  `IdCanal` int(11) NOT NULL,
  `NomCanal` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `IdProjet` int(11) NOT NULL,
  `NomProjet` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `IdUser` int(11) NOT NULL,
  `NomsUser` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `IdTache` int(11) NOT NULL,
  `NomTache` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `NomManager` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `EtapeProjet` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- --------------------------------------------------------

--
-- Structure de la table `t_canalt`
--
...
CREATE TABLE `t_canalt` (
  ...
  `NomsManager` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `DateE` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Structure de la table `t_canaltache`
--
...
CREATE TABLE `t_canaltache` (
  ...
  `NomRedacteur` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `t_categorie` (
  `id_categorie` int(11) NOT NULL,
  `nom_categorie` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `description_categorie` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `date_creation` varchar(40) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `id_user` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `couleur` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Structure de la table `t_categorie_equipe`
--

CREATE TABLE `t_categorie_equipe` (
  `id_cat_equipe` int(11) NOT NULL,
  `nom_cat_equipe` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `description_cat_equipe` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `date` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `id_user_aj` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `t_categorie_equipe`
--
...
--
-- Structure de la table `t_chatpanel`
--
...
CREATE TABLE `t_chatpanel` (
  ...
  `heureEnvoie` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `t_chatpanel`
--
...
CREATE TABLE `t_comment` (
  `Id` int(11) NOT NULL,
  `Noms` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `Email` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `Message` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `Date` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `Departement` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `t_commentaires` (
  ...
  `commentaires` text CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
...
--
-- Structure de la table `t_comptabilaninitial`
--
...
--
-- Déchargement des données de la table `t_comptabilaninitial`
--
...
--
-- Structure de la table `t_comptacomptes`
--

CREATE TABLE `t_comptacomptes` (
  `id` int(11) NOT NULL,
  `Nom_compte` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Num_compte` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Type_compte` int(11) NOT NULL,
  `Description_compte` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Statut` int(11) NOT NULL DEFAULT 1,
  `Categorie` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ;

--
-- Déchargement des données de la table `t_comptacomptes`
--
...
--
-- Structure de la table `t_comptaecritures`
--

CREATE TABLE `t_comptaecritures` (
  `id` int(11) NOT NULL,
  `Compte` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Periode` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Date` date NOT NULL,
  ...
  `Bureau` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `TypeJournal` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `exTypeJournal` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Piececompt` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'nofile.png',
  `UniqueIndex` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `idUser` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `t_comptaecritures`
--
...
--
-- Structure de la table `t_comptaecritureshold`
--

CREATE TABLE `t_comptaecritureshold` (
  `id` int(11) NOT NULL,
  `Indexsauv` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Compte` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Code` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Periode` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Date` date NOT NULL,
...
--
-- Structure de la table `t_comptaecriturestempo`
--
...
CREATE TABLE `t_comptaecriturestempo` (
  ...
  `Taux` double NOT NULL,
  `Bureau` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Departement` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '1 débit, 2 crédit',
  `Source` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `Type_ec` int(11) NOT NULL,
  `Tva_ecriture` float DEFAULT 0,
  `DateEnreg_ecriture` timestamp NOT NULL DEFAULT current_timestamp(),
...
--
-- Structure de la table `t_comptagrandlivre`
--

CREATE TABLE `t_comptagrandlivre` (
  `id` int(11) NOT NULL,
  `Num_ecriture` int(11) NOT NULL,
  `Libelle_ecriture` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Structure de la table `t_comptajournaux`
--

CREATE TABLE `t_comptajournaux` (
  `id` int(11) NOT NULL,
  `Designation` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `refcompte` varchar(15) DEFAULT NULL COMMENT 'compte par defaut',
  `typejournal` int(11) NOT NULL COMMENT '1.banque, 2.caisse,3.divers, 4.vente, 5.achat',
  `Description` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `UniqueCode` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
--
-- Déchargement des données de la table `t_comptajournaux`
--
...
--
-- Structure de la table `t_comptalistecomptes`
--

CREATE TABLE `t_comptalistecomptes` (
  `id` int(11) NOT NULL,
  `Numero` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `Nom` varchar(58) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `t_comptalistecomptes`
--
...
--
-- Structure de la table `t_comptaperiodes`
--
...
CREATE TABLE `t_comptaperiodes` (
  ...
  `Mois` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `Debut` date NOT NULL,
  `Fin` date NOT NULL,
  `IntervalDate` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `t_comptaperiodes`
--
...
--
-- Structure de la table `t_comptapieces`
--
...
--
-- Structure de la table `t_comptareferences`
--
...
--
-- Déchargement des données de la table `t_comptareferences`
--
...
--
-- Structure de la table `t_comptatypecomptes`
--

CREATE TABLE `t_comptatypecomptes` (
  `id` int(11) NOT NULL,
  `Nom_type` varchar(70) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `t_comptatypecomptes`
--
...
--
-- Structure de la table `t_comptavaleurs`
--
...
CREATE TABLE `t_comptavaleurs` (
  ...
  `refdoc` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'nofile.png',
  `date_modif` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `t_comptavaleurs`
--
...
--
-- Structure de la table `t_salairebase`
--
...
--
-- Déchargement des données de la table `t_salairebase`
--
...
--
-- Index pour la table `plan_approvisionnement`
--
ALTER TABLE `plan_approvisionnement`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `type_procedure`
--
ALTER TABLE `type_procedure`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `t_about`
--
ALTER TABLE `t_about`
  ADD PRIMARY KEY (`id_about`);

--
-- Index pour la table `t_activites_prog`
--
ALTER TABLE `t_activites_prog`
  ADD PRIMARY KEY (`Id`);

--
-- Index pour la table `t_agendaevents`
--
...
--
-- Index pour la table `t_agents`
--
ALTER TABLE `t_agents`
  ADD PRIMARY KEY (`Id_Agent`);

--
-- Index pour la table `t_agentsintegres`
--
ALTER TABLE `t_agentsintegres`
  ADD PRIMARY KEY (`Id_Agent`);

--
-- Index pour la table `t_agent_org`
--
ALTER TABLE `t_agent_org`
  ADD PRIMARY KEY (`Id`);

--
-- Index pour la table `t_alldeloc`
--
ALTER TABLE `t_alldeloc`
  ADD PRIMARY KEY (`Id`);

--
-- Index pour la table `t_allfam`
--
ALTER TABLE `t_allfam`
  ADD PRIMARY KEY (`Id`);

--
-- Index pour la table `t_allloge`
--
ALTER TABLE `t_allloge`
  ADD PRIMARY KEY (`Id`);

--
-- Index pour la table `t_alltrans`
--
...
--
-- Index pour la table `t_answerskill`
--
ALTER TABLE `t_answerskill`
  ADD PRIMARY KEY (`Id`);

--
-- Index pour la table `t_archiveclasseur`
--
...
--
-- Index pour la table `t_archivedossier`
--
...
--
-- Index pour la table `t_archivefichier`
--
...
--
-- Index pour la table `t_avances`
--
ALTER TABLE `t_avances`
  ADD PRIMARY KEY (`Id`);

--
-- Index pour la table `t_avancess`
--
ALTER TABLE `t_avancess`
  ADD PRIMARY KEY (`Id`);

--
-- Index pour la table `t_blog`
--
ALTER TABLE `t_blog`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `t_calcul`
--
ALTER TABLE `t_calcul`
  ADD PRIMARY KEY (`Id`);

--
-- Index pour la table `t_cal_parametre`
--
ALTER TABLE `t_cal_parametre`
  ADD PRIMARY KEY (`Id`);

--
-- Index pour la table `t_canal`
--
ALTER TABLE `t_canal`
  ADD PRIMARY KEY (`IdCanal`);

--
-- Index pour la table `t_canalt`
--
ALTER TABLE `t_canalt`
  ADD PRIMARY KEY (`IdCanal`);

--
-- Index pour la table `t_canaltache`
--
...
--
-- Index pour la table `t_categorie_equipe`
--
ALTER TABLE `t_categorie_equipe`
  ADD PRIMARY KEY (`id_cat_equipe`);

--
-- Index pour la table `t_chatpanel`
--
...
--
-- Index pour la table `t_comptabilaninitial`
--
...
--
-- Index pour la table `t_comptacomptes`
--
...
--
-- Index pour la table `t_comptaecritures`
--
...
--
-- Index pour la table `t_comptaecritureshold`
--
ALTER TABLE `t_comptaecritureshold`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `t_comptaecriturestempo`
--
...
--
-- Index pour la table `t_comptagrandlivre`
--
ALTER TABLE `t_comptagrandlivre`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `t_comptajournaux`
--
...
--
-- Index pour la table `t_comptalistecomptes`
--
ALTER TABLE `t_comptalistecomptes`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `t_comptaperiodes`
--
...
--
-- Index pour la table `t_comptapieces`
--
...
--
-- Index pour la table `t_comptareferences`
--
...
--
-- Index pour la table `t_comptatypecomptes`
--
ALTER TABLE `t_comptatypecomptes`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `t_comptavaleurs`
--
ALTER TABLE `t_comptavaleurs`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `t_salairebase`
--
...
--
-- AUTO_INCREMENT pour la table `plan_approvisionnement`
--
ALTER TABLE `plan_approvisionnement`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `type_procedure`
--
ALTER TABLE `type_procedure`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT pour la table `t_about`
--
ALTER TABLE `t_about`
  MODIFY `id_about` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `t_activites_prog`
--
ALTER TABLE `t_activites_prog`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `t_agendaevents`
--
ALTER TABLE `t_agendaevents`
  MODIFY `IdEvent` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;

--
-- AUTO_INCREMENT pour la table `t_agents`
--
ALTER TABLE `t_agents`
  MODIFY `Id_Agent` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `t_agentsintegres`
--
ALTER TABLE `t_agentsintegres`
  MODIFY `Id_Agent` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT pour la table `t_agent_org`
--
ALTER TABLE `t_agent_org`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT pour la table `t_alldeloc`
--
ALTER TABLE `t_alldeloc`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `t_allfam`
--
ALTER TABLE `t_allfam`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `t_allloge`
--
ALTER TABLE `t_allloge`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `t_alltrans`
--
ALTER TABLE `t_alltrans`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT pour la table `t_answers`
--
ALTER TABLE `t_answers`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT pour la table `t_answerskill`
--
ALTER TABLE `t_answerskill`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=195;

--
-- AUTO_INCREMENT pour la table `t_archiveclasseur`
--
ALTER TABLE `t_archiveclasseur`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT pour la table `t_archivedossier`
--
ALTER TABLE `t_archivedossier`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT pour la table `t_archivefichier`
--
ALTER TABLE `t_archivefichier`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `t_avances`
--
ALTER TABLE `t_avances`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `t_avancess`
--
ALTER TABLE `t_avancess`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `t_blog`
--
ALTER TABLE `t_blog`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `t_calcul`
--
ALTER TABLE `t_calcul`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `t_cal_parametre`
--
ALTER TABLE `t_cal_parametre`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `t_canal`
--
ALTER TABLE `t_canal`
  MODIFY `IdCanal` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `t_canalt`
--
ALTER TABLE `t_canalt`
  MODIFY `IdCanal` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `t_canaltache`
--
ALTER TABLE `t_canaltache`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT pour la table `t_categorie_equipe`
--
ALTER TABLE `t_categorie_equipe`
  MODIFY `id_cat_equipe` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `t_chatpanel`
--
ALTER TABLE `t_chatpanel`
...
--
-- AUTO_INCREMENT pour la table `t_comptabilaninitial`
--
ALTER TABLE `t_comptabilaninitial`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=131;

--
-- AUTO_INCREMENT pour la table `t_comptacomptes`
--
ALTER TABLE `t_comptacomptes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `t_comptaecritures`
--
ALTER TABLE `t_comptaecritures`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT pour la table `t_comptaecritureshold`
--
ALTER TABLE `t_comptaecritureshold`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `t_comptaecriturestempo`
--
ALTER TABLE `t_comptaecriturestempo`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT pour la table `t_comptagrandlivre`
--
ALTER TABLE `t_comptagrandlivre`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `t_comptajournaux`
--
ALTER TABLE `t_comptajournaux`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT pour la table `t_comptalistecomptes`
--
ALTER TABLE `t_comptalistecomptes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=704;

--
-- AUTO_INCREMENT pour la table `t_comptaperiodes`
--
ALTER TABLE `t_comptaperiodes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `t_comptapieces`
--
ALTER TABLE `t_comptapieces`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `t_comptareferences`
--
ALTER TABLE `t_comptareferences`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=116;

--
-- AUTO_INCREMENT pour la table `t_comptatypecomptes`
--
ALTER TABLE `t_comptatypecomptes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `t_comptavaleurs`
--
ALTER TABLE `t_comptavaleurs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `t_salairebase`
--
ALTER TABLE `t_salairebase`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Contraintes pour la table `t_archiveclasseur`
--
ALTER TABLE `t_archiveclasseur`
  ADD CONSTRAINT `t_archiveclasseur_ibfk_1` FOREIGN KEY (`idUser`) REFERENCES `t_utilisateurs` (`Id`);

--
-- Contraintes pour la table `t_archivedossier`
--
ALTER TABLE `t_archivedossier`
  ADD CONSTRAINT `fk_classeur` FOREIGN KEY (`idClasseur`) REFERENCES `t_archiveclasseur` (`uniqueId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_usercc` FOREIGN KEY (`idUser`) REFERENCES `t_utilisateurs` (`Id`) ON UPDATE CASCADE;

--
-- Contraintes pour la table `t_archivefichier`
--
ALTER TABLE `t_archivefichier`
  ADD CONSTRAINT `fk_dossier` FOREIGN KEY (`idDossier`) REFERENCES `t_archivedossier` (`uniqueId`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_userdoc` FOREIGN KEY (`userID`) REFERENCES `t_archivedossier` (`idUser`);

--
-- Contraintes pour la table `t_comptabilaninitial`
--
ALTER TABLE `t_comptabilaninitial`
  ADD CONSTRAINT `fk_code` FOREIGN KEY (`code`) REFERENCES `t_comptacomptes` (`Num_compte`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Contraintes pour la table `t_comptaecritures`
--
ALTER TABLE `t_comptaecritures`
  ADD CONSTRAINT `fk_journcode` FOREIGN KEY (`TypeJournal`) REFERENCES `t_comptajournaux` (`Code`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_userId` FOREIGN KEY (`idUser`) REFERENCES `t_utilisateurs` (`Id`);

--
-- Contraintes pour la table `t_comptaecriturestempo`
--
ALTER TABLE `t_comptaecriturestempo`
  ADD CONSTRAINT `fk_journal` FOREIGN KEY (`TypeJournal`) REFERENCES `t_comptajournaux` (`Code`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_user` FOREIGN KEY (`idUser`) REFERENCES `t_utilisateurs` (`Id`);

--
-- Contraintes pour la table `t_comptajournaux`
--
ALTER TABLE `t_comptajournaux`
  ADD CONSTRAINT `fk_user_jrn` FOREIGN KEY (`idUser`) REFERENCES `t_utilisateurs` (`Id`);
COMMIT;
