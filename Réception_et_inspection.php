...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Réception et inspection</title>
    ...
    <main class="main" id="top">
      <div class="container-fluid" data-layout="container-fluid">
       ...
       <!-- nav prime  -->
        ...
        <!-- content -->
       <?php include_once "./pages/Reception_et_inspection/receptionInspection.php"; ?>
       <!-- modal section -->
...
<!-- setting button -->
 <?php include_once "settings.php"; ?>
   ...
   <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
    ...
    <script src="./pages/Reception_et_inspection/reception.js"></script>
    <!-- toast -->
